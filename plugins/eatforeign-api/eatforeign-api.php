...
require_once EATFOREIGN_API_DIR . 'includes/class-image-attribution.php';
require_once EATFOREIGN_API_DIR . 'includes/class-image-client.php';
require_once EATFOREIGN_API_DIR . 'includes/class-dish-generated-image-store.php';
require_once EATFOREIGN_API_DIR . 'includes/class-openai-image-client.php';
require_once EATFOREIGN_API_DIR . 'includes/class-gemini-image-client.php';
...
require_once EATFOREIGN_API_DIR . 'includes/class-celebration-date-repair.php';
